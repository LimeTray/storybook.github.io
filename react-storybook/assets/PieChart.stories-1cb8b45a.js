import{j as m}from"./jsx-runtime-8406ef1e.js";import{r as l}from"./index-ad58220e.js";import{C as $}from"./auto-a199c2c6.js";import{_ as u}from"./lodash-9978a6f3.js";import"./_commonjsHelpers-de833af9.js";const B=({data:r,options:c})=>{const p=l.useRef(null),o=l.useRef(null),D={responsive:!0,plugins:{legend:{position:"bottom",labels:{generateLabels:t=>{const a=t.data.datasets[0];return(t.data.labels??[]).map((s,e)=>{const W=a.data[e];return{text:`${s}: ${W}`,...a.backgroundColor&&{fillStyle:a.backgroundColor[e]},hidden:!t.getDataVisibility(e),index:e}})}}},tooltip:{mode:"index",intersect:!1,callbacks:{label:function(t){const a=t.raw||0,s=t.chart._metasets[0].total;return` ${(a/s*100).toFixed(2)}%`}}}}};function _(t,a){return u.mergeWith({},t,a,(s,e)=>u.isObject(s)&&u.isObject(e)?u.merge({},s,e):e!==void 0?e:s)}return l.useEffect(()=>{const t=_(D,c);return p.current&&(o.current&&o.current.destroy(),o.current=new $(p.current,{type:"pie",data:r,options:t})),()=>{o.current&&o.current.destroy()}},[r,c]),m.jsx("canvas",{ref:p})},A=B;B.__docgenInfo={description:"",methods:[],displayName:"PieChart",props:{data:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
Adjust tooltips, legends, and other plugins for additional customization.
      `}}};var g,C,f,b,y;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`args => {
  return <div style={{
    maxWidth: '400px',
    margin: 'auto'
  }}>
...
}`,...(f=(C=n.parameters)==null?void 0:C.docs)==null?void 0:f.source},description:{story:"This story demonstrates the `PieChart` with default data and options.",...(y=(b=n.parameters)==null?void 0:b.docs)==null?void 0:y.description}}};var F,v,P,j,x;i.parameters={...i.parameters,docs:{...(F=i.parameters)==null?void 0:F.docs,source:{originalSource:`args => {
  return <div style={{
    maxWidth: '400px',
    margin: 'auto'
  }}>
...
}`,...(P=(v=i.parameters)==null?void 0:v.docs)==null?void 0:P.source},description:{story:"This story showcases how to position the legend to the right of the chart.",...(x=(j=i.parameters)==null?void 0:j.docs)==null?void 0:x.description}}};var k,w,T,E,O;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`args => {
  return <div style={{
    maxWidth: '400px',
    margin: 'auto'
  }}>
...
}`,...(T=(w=d.parameters)==null?void 0:w.docs)==null?void 0:T.source},description:{story:"This story demonstrates how to customize tooltips to show both absolute values and percentages for each data segment.",...(O=(E=d.parameters)==null?void 0:E.docs)==null?void 0:O.description}}};const Z=["Default","CustomLegendPosition","WithCustomTooltips"];export{i as CustomLegendPosition,n as Default,d as WithCustomTooltips,Z as __namedExportsOrder,L as default};
