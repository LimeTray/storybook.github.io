import{j as i}from"./jsx-runtime-ffb262ed.js";import{r as x}from"./index-76fb7be0.js";import{g as I}from"./requestIdGenerator-f6efc017.js";/* empty css              */import"./_commonjsHelpers-de833af9.js";class l extends x.Component{constructor(e){super(e),this.mapTabItems=(a,t)=>{const{showNumbers:g,tabType:v,selectedTabFunc:o}=this.props,{selectedTabIndex:h}=this.state;return i.jsxs("div",{onClick:()=>{this.setState({selectedTabIndex:t},()=>{o&&o(a)})},style:{},onKeyDown:()=>{},role:"button",tabIndex:t,className:`tab-item ${t===h?"active":""} 
